...
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/oplus/kernel_4.19/audio/codecs/sia81xx_1.1.9/Module.symvers)
include $(MY_LOCAL_PATH)/codecs/sia81xx_1.2.0/Android.mk
else
...
#Add for PA manager
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/oplus/kernel_4.19/audio/codecs/common/Module.symvers)
include $(MY_LOCAL_PATH)/codecs/common/Android.mk

#Add for aw882xx
$(shell rm -rf $(PRODUCT_OUT)/obj/vendor/oplus/kernel_4.19/audio/codecs/aw882xx/Module.symvers)
include $(MY_LOCAL_PATH)/codecs/aw882xx/Android.mk
